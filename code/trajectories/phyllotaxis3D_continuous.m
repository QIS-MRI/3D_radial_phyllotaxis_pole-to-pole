...
% PHYLLOTAXIS3D_CONTINUOUS  Generates the continuous 3D phyllotaxis trajectory. (2024)
%
%   [m_adPolarAngle, m_adAzimuthalAngle, x, y, z] = phyllotaxis3D_continuous(m_lNumberOfFrames, m_lProjectionsPerFrame, flagSelf)
%
%   Inputs:
