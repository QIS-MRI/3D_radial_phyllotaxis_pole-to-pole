...
% PHYLLOTAXIS3D_ORIGINAL  Generates the original 3D phyllotaxis trajectory. 
%
%   [m_adPolarAngle, m_adAzimuthalAngle, x, y, z] = phyllotaxis3D_original(m_lNumberOfFrames, m_lProjectionsPerFrame, flagSelf)
%
%   Inputs:
